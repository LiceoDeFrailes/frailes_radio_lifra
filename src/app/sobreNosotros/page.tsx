    ...
    <Layout>
      ...
      <section className="py-20 bg-muted/40">
        <motion.div
          ...
          transition={{ duration: 0.7 }}
        >
          <h2 className="text-4xl font-bold mb-6 text-center">Historia del Liceo de Frailes</h2>

          <p className="text-lg text-muted-foreground leading-relaxed text-center">
            El Liceo de Frailes con Orientación Tecnológica fue fundado en 1976 gracias a la donación del terreno por la Asociación de Desarrollo Integral de Frailes. 
            Tras funcionar brevemente, cerró por baja matrícula y reabrió en 1995 como Unidad Pedagógica Cecilio Piedra, recuperando su categoría de Liceo en 1997. 
            En 2007 inició su transformación hacia la modalidad tecnológica que mantiene hoy. Entre 2019 y 2021 se construyó un nuevo edificio con modernas aulas, biblioteca, laboratorio de informática y áreas administrativas. 
            Atiende estudiantes de múltiples comunidades, entre ellas El Rosario, La Fila, San Juan, Santa Elena, San Cristóbal Sur, La Violeta, Bustamante y Frailes.
          </p>
        </motion.div>
      </section>
